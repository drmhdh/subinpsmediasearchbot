...
async def echo(bot, message):
    ...
    if message.from_user.id == ADMIN: 
        ...
        if message.reply_to_message:
            ...
            await bot.copy_message(chat_id=message.from_user.id, from_chat_id=ADMIN, message_id=message.from_user.id, reply_to_message_id=message.reply_to_message.message_id)
