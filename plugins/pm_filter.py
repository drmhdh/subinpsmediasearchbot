...
async def echo(bot, message):
    ...
    if message.from_user.id == ADMIN: 
        ...
        if message.reply_to_message:
            ...
            await bot.copy_message(from_chat_id=ADMIN, message_id=message.from_user.message_id, reply_to_message_id=message.reply_to_medsage_id, allow_sending_without_reply=True)
